...
void IrcStoreCurrent(
	...
	uvec4 lobeWordsB;
	uint lobeWordC;
	uvec4 directLobeWordsA;
	uvec4 directLobeWordsB;
	uint directLobeWordC;
	IrcEncodeWords(
		entry,
		baseWords,
		positiveWords,
	...
	if ((currentFrame & 1) == 0) {
		irradianceCacheA[word] = baseWords.x;
		irradianceCacheA[word + 1u] = baseWords.y;
		irradianceCacheA[word + 2u] = baseWords.z;
		irradianceCacheA[word + 3u] = baseWords.w;
		irradianceCacheA[word + 4u] = positiveWords.x;
		irradianceCacheA[word + 5u] = positiveWords.y;
		irradianceCacheA[word + 6u] = positiveWords.z;
		irradianceCacheA[word + 7u] = negativeWords.x;
		irradianceCacheA[word + 8u] = negativeWords.y;
		irradianceCacheA[word + 9u] = negativeWords.z;
		irradianceCacheA[word + 10u] = lobeWordsA.x;
		irradianceCacheA[word + 11u] = lobeWordsA.y;
		irradianceCacheA[word + 12u] = lobeWordsA.z;
		irradianceCacheA[word + 13u] = lobeWordsA.w;
		irradianceCacheA[word + 14u] = lobeWordsB.x;
		irradianceCacheA[word + 15u] = lobeWordsB.y;
		irradianceCacheA[word + 16u] = lobeWordsB.z;
		irradianceCacheA[word + 17u] = lobeWordsB.w;
		irradianceCacheA[word + 18u] = lobeWordC;
		irradianceCacheA[word + 19u] = directLobeWordsA.x;
		irradianceCacheA[word + 20u] = directLobeWordsA.y;
		irradianceCacheA[word + 21u] = directLobeWordsA.z;
		irradianceCacheA[word + 22u] = directLobeWordsA.w;
		irradianceCacheA[word + 23u] = directLobeWordsB.x;
		irradianceCacheA[word + 24u] = directLobeWordsB.y;
		irradianceCacheA[word + 25u] = directLobeWordsB.z;
		irradianceCacheA[word + 26u] = directLobeWordsB.w;
		irradianceCacheA[word + 27u] = directLobeWordC;
	} else {
		irradianceCacheB[word] = baseWords.x;
		irradianceCacheB[word + 1u] = baseWords.y;
		irradianceCacheB[word + 2u] = baseWords.z;
		irradianceCacheB[word + 3u] = baseWords.w;
		irradianceCacheB[word + 4u] = positiveWords.x;
		irradianceCacheB[word + 5u] = positiveWords.y;
		irradianceCacheB[word + 6u] = positiveWords.z;
		irradianceCacheB[word + 7u] = negativeWords.x;
		irradianceCacheB[word + 8u] = negativeWords.y;
		irradianceCacheB[word + 9u] = negativeWords.z;
		irradianceCacheB[word + 10u] = lobeWordsA.x;
		irradianceCacheB[word + 11u] = lobeWordsA.y;
		irradianceCacheB[word + 12u] = lobeWordsA.z;
		irradianceCacheB[word + 13u] = lobeWordsA.w;
		irradianceCacheB[word + 14u] = lobeWordsB.x;
		irradianceCacheB[word + 15u] = lobeWordsB.y;
		irradianceCacheB[word + 16u] = lobeWordsB.z;
		irradianceCacheB[word + 17u] = lobeWordsB.w;
		irradianceCacheB[word + 18u] = lobeWordC;
		irradianceCacheB[word + 19u] = directLobeWordsA.x;
		irradianceCacheB[word + 20u] = directLobeWordsA.y;
		irradianceCacheB[word + 21u] = directLobeWordsA.z;
		irradianceCacheB[word + 22u] = directLobeWordsA.w;
		irradianceCacheB[word + 23u] = directLobeWordsB.x;
		irradianceCacheB[word + 24u] = directLobeWordsB.y;
		irradianceCacheB[word + 25u] = directLobeWordsB.z;
		irradianceCacheB[word + 26u] = directLobeWordsB.w;
		irradianceCacheB[word + 27u] = directLobeWordC;
	}
}
